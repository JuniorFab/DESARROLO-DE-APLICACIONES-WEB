...
public class Departamento implements Comparable<Departamento>{
    ...
    public int hashCode() {
        int hash = 7;
        hash = 17 * hash + this.dept_no;
        hash = 17 * hash + Objects.hashCode(this.dnombre);
    ...
    public int compareTo(Departamento o) {
        if(this.getDept_no() < o.getDept_no()) return -1;
        else  if(this.getDept_no() > o.getDept_no()) return 1;
        else return 0;
    }
